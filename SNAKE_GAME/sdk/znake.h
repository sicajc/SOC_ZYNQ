...
#define snakeSpeed 0.5 //Initial speed of snake in seconds, this means half second.
#define initDelayValue snakeSpeed*clockFreq //Calculating the initial value for the event timer, this is used to syncrhonise with the event timer written in HW
...
//Structure representing Znake, structure controlling the entire snake controlling
typedef struct{
	char *Buffer;
    //Since we have 3 different IPs, thus we need 3 address MMIO to access them.
	u32 BaseAddress;
