...
HD_PWD='C:/Users/User/Desktop/SOC_FINAL_PROJECT/spiController/spiController/spiController.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log spiControl.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source spiControl.tcl -notrace
